...
#EOF
echo "adding the cloud repo for FOlSOM release of OpenStack swift"
###Adding the ubuntu cloud repo for FOLSOM release of OpenStack Swift ########
...
#show all Container or in the Container file
# swift list
# swift list <Container-name>

#file upload
# swift upload <Container-name> file.zip

#file Download
# swift download <Container-name> file.zip
